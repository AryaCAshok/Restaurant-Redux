...
function RestView() {
  ...
  const selectedRestaurant=allRestaurant?.filter(item=>item.id==id) //to avoid error after allRestaurant give ?
  ...
  return (
    <>
      <Row className='mt-5 mb-5'>
        ...
        <Col md={7} lg={7}>
          <hr />
          <h4 className='text-center'><span className='text-warning me-3'>Restaurant</span>Details</h4>
          <hr />
          <ListGroup>
            ...
            <ListGroup.Item>Cuisin Type:<span>{selectedRestaurant[0].cuisine_type}</span></ListGroup.Item>
            <ListGroup.Item className='text-center p-3'><button className='btn btn-warning ' onClick={handleShow}>Operating Hours</button><span></span>
